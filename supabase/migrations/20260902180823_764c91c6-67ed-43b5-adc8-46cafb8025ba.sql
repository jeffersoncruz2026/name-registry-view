...
grant select, insert, update, delete on public.cepea_cotacoes to authenticated;
grant all on public.cepea_cotacoes to service_role;
grant select, insert on public.cepea_importacoes to authenticated;
grant all on public.cepea_importacoes to service_role;
